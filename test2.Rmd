...
iterations = 5 #It takes a long time, but for stable results use at least 100
...
selection =read.csv("C:/Users/nlotfi/Desktop/Run_r//input/Names_impo.csv",  as.is=1)
...
seq_Gnorm_gamma_mean = Unite_list_of_dataframes(Seq_G_Mean_gamma_list)
selection =read.csv("C:/Users/nlotfi/Desktop/Run_r//input/Names_impo_plants.csv",  as.is=1)
selection = selection[order(selection$name),]
for (i in 1:length(selection)) {
...
for (mm in 1:permutation){
  file_name_links = paste(path_out,"rand_", mm, "_links_10_492.csv", sep ="")
