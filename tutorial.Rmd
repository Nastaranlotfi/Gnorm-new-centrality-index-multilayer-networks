...
To have a better view of the Gnorm, we plot the histogram of the frequency of the Gnorm as the following:
...
To have a better view of the species Gnorm value, we plotted the Gnorm of the species that they were detected being important in the nature (names taken from 2019 NatEcoEvo paper).
