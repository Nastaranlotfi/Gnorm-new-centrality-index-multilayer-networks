...
Build multilayer networks for the complete empirical network and its giant component:
...
To have a view of the network, we plot both the empirical network and its giant component:
...
In the subsequent analyses, we work only with the giant component. First, we define the main parameters to calculate  Gnorm:
