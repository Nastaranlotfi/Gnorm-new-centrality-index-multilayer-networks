...
In the following, we gain two major plots: 1. the 2D plots and 2. 2D heatmap plots. 
1. The 2D plots show that how the variation of the Gnorm changes for the selected species by variation of the omega (w). Different lines indicated for different gammas. 
2. The 2D heatmap plots show the variation the Gnorm with respect to the omega and the gamma. The color of the plot is the mean Gnorm of the species.
