...
Ploting_bats<-function(selection,main_data, v_bats,savename){
	...
	create_beautiful_radarchart(data = df, color = c("#FFC0CB","#87CEFA", "#FFDAB9", "#90EE90", "#EEE8AA"))
	# Add an horizontal legend
	legend(
  	x = "left", legend = rownames(df[-c(1,2),]), horiz = FALSE,
 	 bty = "n", pch = 20 , col =c("#FFC0CB","#87CEFA", "#FFDAB9", "#90EE90", "#EEE8AA"),
...
Ploting_plants<-function(selection,main_data, v_bats,savename){
